...
});define("pages/utils.js",["appmsg/appmsg_report.js","biz_common/utils/emoji_data.js","pages/version4video.js","biz_wap/utils/mmversion.js","biz_wap/jsapi/core.js","biz_common/dom/event.js","common/comm_report.js","common/utils.js","appmsg/i18n.js"],function(require,exports,module,alert){
"use strict";
function getParam(e){
if(!e)return null;
...
var n=document.body.offsetHeight,i=commonUtils.getInnerHeight()+t;
if(i>n){
var o=t+commonUtils.getInnerHeight()-document.body.offsetHeight,a=document.createElement("div");
...
JSAPI.on("menu:share:appmessage",function(n){
var i=void 0;
n&&"favorite"===n.scene?(i=24,t.link=changeURLArg(t.link,"scene",sceneType[1])):(i=1,
t.link=changeURLArg(t.link,"scene",sceneType[0])),shareReport({
url:t.link,
actionType:i,
albumId:e.album_id,
albumType:e.album_type
}),JSAPI.invoke("sendAppMessage",t);
}),JSAPI.on("menu:share:timeline",function(){
e.video_album&&(t.link=changeURLArg(t.link,"scene",sceneType[2])),shareReport({
url:t.link,
actionType:sceneType[2],
albumId:e.album_id,
albumType:e.album_type
}),JSAPI.invoke("shareTimeline",t);
}),JSAPI.on("menu:share:weiboApp",function(){
e.video_album&&(t.link=changeURLArg(t.link,"scene",sceneType[3])),shareReport({
url:t.link,
actionType:3,
albumId:e.album_id,
albumType:e.album_type
...
e.video_album&&(t.link=changeURLArg(t.link,"scene",sceneType[3])),shareReport({
url:t.link,
actionType:sceneType[3],
albumId:e.album_id,
albumType:e.album_type
}),JSAPI.invoke("shareFB",t);
}),JSAPI.on("menu:share:QZone",function(){
e.video_album&&(t.link=changeURLArg(t.link,"scene",sceneType[4])),shareReport({
url:t.link,
actionType:sceneType[4],
albumId:e.album_id,
albumType:e.album_type
}),JSAPI.invoke("shareQZone",t);
}),JSAPI.on("menu:share:qq",function(){
e.video_album&&(t.link=changeURLArg(t.link,"scene",sceneType[5])),shareReport({
url:t.link,
actionType:sceneType[5],
albumId:e.album_id,
albumType:e.album_type
}),JSAPI.invoke("shareQQ",t);
}),JSAPI.on("menu:share:email",function(){
e.video_album&&(t.link=changeURLArg(t.link,"scene",sceneType[6])),shareReport({
url:t.link,
actionType:sceneType[6],
albumId:e.album_id,
albumType:e.album_type
...
function getQuery(e){
for(var t=window.location.href,n=t.indexOf("?"),i=t.substr(n+1),o=i.split("&"),a=0;a<o.length;a++){
var r=o[a].split("=");
if(r[0].toUpperCase()==e.toUpperCase())return r[1];
}
return"";
}
function prepareNativePage(e,t){
...
clearTimeout(i),i=setTimeout(r,t),l&&e.apply(o,a);
};
}
function formatSeconds(e){
var t=parseInt(e,10),n=0,i=0;
t>60&&(n=parseInt(t/60,10),t=parseInt(t%60,10),n>60&&(i=parseInt(n/60,10),n=parseInt(n%60,10))),
10>t&&(t="0"+t);
var o=":"+t;
return n>0?(10>n&&(n="0"+n),o=n+o):o="00"+o,i>0&&(0===parseInt(i,10)?i="":10>i&&(i="0"+i),
o=""+i+":"+o),o;
}
...
var n=""+parseInt(e,10)/1e4,i=n.indexOf(".");
t=-1===i?n+"0K":n.substr(0,i)+"."+n.charAt(i+1)+"0K";
...
n&&n+t>r?(clearTimeout(i),i=setTimeout(function(){
n=r,e.apply(o,a);
},t)):(n=r,e.apply(o,a));
};
}
...
!function(){
for(var e=0,t=EmojiData.length;t>e;e++){
var n=EmojiData[e];
n.cn&&!g.emojiDataMap[n.cn]&&(g.emojiDataMap[n.cn]={
index:e
}),n.hk&&!g.emojiDataMap[n.hk]&&(g.emojiDataMap[n.hk]={
index:e
}),n.us&&!g.emojiDataMap[n.us]&&(g.emojiDataMap[n.us]={
index:e
});
}
}();
...
var t=EmojiData[g.emojiDataMap[e].index];
return g.emojiImg.replace("#name#",e).replace("#style#",t.style);
}
return e;
}):e;
},jumpUrl=function(e,t){
g.inWechat?g.windowWechat||g.macWechat?t===!0?window.parent.open(e):window.parent.location.href=e:JSAPI.invoke("openUrlWithExtraWebview",{
url:e,
openType:1
},function(n){
...
WapReport.report(10380,t,{
success:function(e){
var n=JSON.parse(e);
1*n.err_code!==0&&"undefined"!=typeof WX_BJ_REPORT&&WX_BJ_REPORT.BadJs&&WX_BJ_REPORT.BadJs.report("mmdata report failed","log_id: 10380",{
...
var t=e.$container;
t&&!Mmversion.isInMiniProgram&&DomEvent.on(t,"tap",".js_go_profile",function(t){
var n=t.delegatedTarget;
n&&!function(){
var t=n.getAttribute("data-biz")||e.biz||window.biz||"";
if("function"==typeof e.beforeGo2Profile&&e.beforeGo2Profile(n),1==window.isprofileblock)JSAPI.invoke("openUrlWithExtraWebview",{
...
var i=n.getAttribute("data-scene")||e.profile_scene||"";
...
},isTimeExpired=function(e,t,n){
var i=!1;
return e&&t&&n&&(t-e)/1e3/3600>n&&(i=!0),i;
};
return{
jumpUrl:jumpUrl,
closeWin:closeWin,
