...
r||d&&0===_.is_mp_video||s||_.pos_type===AD_POS.POS_AD_AFTER_VIDEO||d&&1===_.is_mp_video||_.pos_type===AD_POS.POS_SPONSOR&&("1"===utils.getExpParaVal(_,94822)||"1"===utils.getExpParaVal(_,"widget_gray_free_trade"))?o.push(_):i.push(_);
}
if(a>1){
for(var l=[],c={
aid:Date.now(),
...
if(e){
var a=document.createElement("iframe"),i=utils.getExpParaVal(t,"widget_gray_iframe_path"),o=utils.getExpParaVal(t,94574),n=null!==o?o:i,p=n?n+"/":"",_=AD_CONFIG.AD_FRAME_DOMAIN+"/tmpl/"+p+"base_tmpl.html";
...
void(commonUtils.isNativePage()?o.createAdWebview(!0):(utils.report115849(33),o.initAdAfterVideo(e)))):e.pos_type===AD_POS.POS_SPONSOR?void o.initSponsorAd(e):void 0;
