...
var n=document.body.offsetHeight,o=commonUtils.getInnerHeight()+t;
if(o>n){
var i=t+commonUtils.getInnerHeight()-document.body.offsetHeight,a=document.createElement("div");
...
var o=void 0;
n&&"favorite"===n.scene?(o=24,t.link=changeURLArg(t.link,"scene",sceneType[1])):(o=1,
...
clearTimeout(o),o=setTimeout(r,t),l&&e.apply(i,a);
};
}
...
var o=n.getAttribute("data-scene")||e.profile_scene||"";
...
var o=!1;
return e&&t&&n&&(t-e)/1e3/3600>n&&(o=!0),o;
};
return{
jumpUrl:jumpUrl,
closeWin:closeWin,
